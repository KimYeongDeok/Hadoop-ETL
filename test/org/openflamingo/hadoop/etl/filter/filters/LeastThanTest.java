...
public class LeastThanTest {
	private FilterClass leastThan;
	@Mock
	private FilterModel filterModel;

	@Before
	public void setUp() throws Exception {
		leastThan = new LeastThan();
	}
	...
	public void testDoFilter() throws Exception {
		...
		boolean success = leastThan.doFilter("1",filterModel);
	...
	public void testFailDoFilter() throws Exception {
		...
		boolean success = leastThan.doFilter("10", filterModel);
	...
	public void testExceptionFilter(){
		...
		boolean success = leastThan.doFilter("data", filterModel);
	}
}
